...
public class Gyro {
    ...
    /*
     * Mount Calibration
     * It’s recommended to perform a mount calibration when placement of the Pigeon
    ...
    /*
     * Documentation
     * https://api.ctr-electronics.com/phoenix6/release/java/com/ctre/phoenix6/
     * hardware/Pigeon2.html
     * 
     * Iterative Example
     * https://github.com/CrossTheRoadElec/Phoenix6-Examples/blob/main/java/Pigeon2/
     ...
     * Rotation2d | getRotation2d() | Returns the heading of the robot as a
     * Rotation2d.
     * Rotation3d | getRotation3d() | Returns the orientation of the robot as a
     * Rotation3d created from the quaternion signals.
     ...
     * The angle increases as the Pigeon 2 turns clockwise when looked at from the
     * top. This follows the NED axis convention.
     * The angle is continuous; that is, it will continue from 360 to 361 degrees.
     * This allows for algorithms that wouldn't want to see a discontinuity in the
