...
/*
 * NOTE
 * https://github.com/MAikenMagic1102/2023SheriffPhoenix6/blob/main/src/main/
 * java/frc/robot/commands/ArmToSetpoint.java
 * 
 ...
 * 
 * 
 * if((Math.abs(upperArmSetpoint - m_Arm.getUpperArmPosition()) < 0.3) &&
 * (Math.abs(lowerArmSetpoint - m_Arm.getLowerArmPosition()) < 0.3)){
